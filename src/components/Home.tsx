...
function Home() {
  return (
    <>
      <div
        className="flex h-screen w-screen items-center bg-slate-50"
        style={{
          ...
          <div className="h-full w-full flex-1">
            <div className="flex h-full flex-col justify-between">
              <div className="flex h-full flex-col items-center justify-between  p-16">
                <div
                  className="h-30 flex h-64 w-full items-center justify-center px-2"
                  style={{
                ...
                <div className="text-center">
                  <button className="w-32 rounded-lg bg-white p-4 font-semibold">
                    Enter
                  </button>
                </div>
              </div>
              <p className="p-2 text-left text-sm">
